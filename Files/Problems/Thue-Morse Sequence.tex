...
\begin{itemize}
	\item If an element is 0, then the turtle rotates \verb!right! by $180^\circ$.
	\item If an element is 1, then the turtle moves \verb!forward! by one unit and then rotates \verb!right! by $60^\circ$.
\end{itemize}
